  ...
  return (
    <div className="page-body">
      <div className="page-header">
        <div>
          <h1 className="page-title">Agenda Inteligente de Citas</h1>
          <p className="page-description">
            Gestión de turnos odontológicos con persistencia en base de datos, edición de estado y control de disponibilidad en tiempo real (HU03).
          </p>
        </div>
        <button
